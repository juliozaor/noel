        ...
        <div>
            <div style="display: flex;
                ...
                <div style="text-align: center; margin-right: 30px; margin-left: 20px;">
                    <h3 style="color:red;margin: 0;padding: 0;font-size: 26px;"> Reservas para el día: <strong>{{$date}}</strong></h3>
                     <p style="font-size: 20px;margin: 0;">
                        En el adjunto se encuentra un archivo excel con las reservas del día.
                     </p>
                </div>
            </div>
        </div>
