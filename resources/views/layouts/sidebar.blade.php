<aside class="menu-lateral p-3 d-flex flex-column">
    ...
    <div class="d-flex flex-column">
        ...
        <a href="{{ route('admin.events.users') }}"
            class="link_side {{ request()->routeIs('admin.events.users') ? 'active' : '' }}">
            <span class="me-2">
        ...
        <a href="{{ route('admin.events.register') }}"
            class="link_side {{ request()->routeIs('admin.events.register') ? 'active' : '' }}">
            <span class="me-2">
        ...
        <a href="{{ route('admin.events.index') }}"
            class="link_side {{ request()->routeIs('admin.events.index') ? 'active' : '' }}">
            <span class="me-2">
        ...
        <a href="{{ route('admin.events.inform') }}"
            class="link_side {{ request()->routeIs('admin.events.inform') ? 'active' : '' }}">
            <span class="me-2">
        ...
        <a href="{{ route('admin.events.readqr') }}"
            class="link_side {{ request()->routeIs('admin.events.readqr') ? 'active' : '' }}">
            <span class="me-2">
