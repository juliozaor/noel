<div>
    ...
    <x-dialog-modal-j wire:model="openNewRegister">
        ...
        <x-slot name="content">
            ...
            {{-- Datos del evento --}}
            {{--  <div class="d-flex fondo-cabecera-modal pt-4 px-6 ps-4 pe-4 ">
                <div class="mr-3 mb-4">
                    <x-label value="Nombre evento:" />
                    <x-label value="Nombre evento" />                  
                </div>
                <div class="mr-3 ml-3 mb-4">
                    <x-label value="Fecha:" />
                    <x-label value="05 / 11 / 2022" />                   
                </div>
                <div class="ml-3 mb-4">
                    <x-label value="Hora:" />
                    <x-label value="3:30 PM" />                   
                </div>
            </div> --}}
            ...
            <div class="d-flex pt-4 px-6 ps-4 pe-4 ">
                <div class="mr-2 w-25">
                    <x-label value="¿Cuál?" />
                    <input type="text" class="w-100 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" wire:model.defer="eps" @if ($epsState !== '1') disabled @endif />
        ...
        <x-slot name="footer" class="bg-success">
            <x-secondary-button wire:click="$set('openNewRegister',false)">
                Cancelar
            </x-secondary-button>
