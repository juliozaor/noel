                            ...
                            <table class="table table-striped fs-12px">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="cursor-pointer"
                                            wire:click="order('profiles.is_collaborator')">
                                            Tipo usuario
                                            <i class="fas fa-sort ml-1 mt-1"></i>
                                        </th>
                                        ...
                                        @foreach ($users as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button
                                                        wire:click="openReservation({{ $user->document }}, 
                                                        {{ $user->id }})"><img
                                                            src="{{ asset('/assets/icons/registerEvents.svg') }}"
                                                            alt="reservas" style="max-width: 15px" /></button>
        ...
        <x-slot name="content">
            ...
            <div class="d-flex pt-4 px-6 ps-4 pe-4 ">
                ...
                <div class="mr-2 w-25">
                    <x-label value="EPS" />
                    <div class="mt-2 ">
                        Si <input wire:model="epsState" name="epsState" type="radio" value="1"
                            class="mr-2" />
            ...
            <div class="d-flex pt-4 px-6 ps-4 pe-4 ">
                ...
                <div class="mr-2 w-25">
                    ...
                    <div class="mt-2">
                        Si <input wire:model.defer="experience2022" name="experience2022" type="radio"
                            value="1" class="mr-2" />
            ...
            <div class="container-table d-flex table-responsive pt-2 px-4">
                <table class="table table-striped fs-12px">
                    <thead>
                        <tr>
                            <th scope="col" class="cursor-pointer"
                                wire:click="orderReservation('programmings.initial_date')">
                                Fecha
                                <i class="fas fa-sort ml-1 mt-1"></i>
                            </th>
                            <th scope="col" class="cursor-pointer"
                                wire:click="orderReservation('programmings.initial_time')">
                                Hora
                                <i class="fas fa-sort ml-1 mt-1"></i>
                            </th>
                            <th scope="col" class="cursor-pointer"
                                wire:click="orderReservation('reservations.quota')">
                                Cupos reservados
                                <i class="fas fa-sort ml-1 mt-1"></i>
                            </th>
                            <th scope="col" class="cursor-pointer"
