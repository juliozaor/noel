<div>
    <div class="w-full max-w-md bg-white rounded-lg shadow-lg p-4 m-auto my-4 relative">
        ...
        <div id="spinner" class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 rounded-lg" style="display: none">
            <div role="status">
        ...
        <div class="flex space-x-2">
            <x-input type="text" id="QRtoken" wire:model.defer="qrcode" class="bg-gray-200 cursor-not-allowed w-100"
                readonly />
